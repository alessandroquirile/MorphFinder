        ...
        <div className="w-full h-full">
            ...
            <div className="absolute bottom-6 right-6 flex flex-col space-y-2 pointer-events-none">
                <div className="bg-white/90 backdrop-blur p-4 rounded-xl border border-slate-200 shadow-xl max-w-xs">
                    <h4 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Structure
                        Details</h4>
                ...
                {homomorphism && (
                    <div
                        className="bg-white/90 backdrop-blur p-4 rounded-xl border border-indigo-100 shadow-xl max-w-xs space-y-4">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                                {homomorphism.kernel.map((val, i) => (
                                    <span key={i}
                                          className="bg-indigo-50 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded border border-indigo-100">
                    {val}
                  </span>
                                ))}
                            </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                                {homomorphism.image.map((val, i) => (
                                    <span key={i}
                                          className="bg-rose-50 text-rose-700 text-[10px] font-bold px-2 py-0.5 rounded border border-rose-100">
                    {val}
                  </span>
                                ))}
                            </div>
